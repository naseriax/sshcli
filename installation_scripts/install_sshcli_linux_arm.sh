GITLAB_URL="https://github.com/naseriax/sshcli/releases/download/20250923.1132/sshcli_linux_arm64"EXISTS": syntax error (1)/sshcli_linux_arm64"EXISTS": syntax error (1)/sshcli_linux_arm64"
