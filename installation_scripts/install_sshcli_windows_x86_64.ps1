$ReleaseUrl = "https://github.com/naseriax/sshcli/releases/download/20250923.1153/sshcli_windows_x86_64.exe"EXISTS": syntax error (1)/sshcli_windows_x86_64.exe"EXISTS": syntax error (1)/sshcli_windows_x86_64.exe"
