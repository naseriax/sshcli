GITLAB_URL="https://github.com/naseriax/sshcli/releases/download/20250923.1153/sshcli_linux_x86_64"EXISTS": syntax error (1)/sshcli_linux_x86_64"EXISTS": syntax error (1)/sshcli_linux_x86_64"
